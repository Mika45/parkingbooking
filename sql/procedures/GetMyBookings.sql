DROP PROCEDURE IF EXISTS GetMyBookings;
CREATE PROCEDURE GetMyBookings(IN `in_email` VARCHAR(50), IN in_user_id INT)
BEGIN
   ...
   SELECT b.booking_id, 
          ...
          END AS can_amend
   FROM   BOOKING b
          LEFT JOIN AFFILIATE a ON (b.affiliate_id = a.affiliate_id AND a.user_id = in_user_id),
          PARKING p
