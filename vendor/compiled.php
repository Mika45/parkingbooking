...
trait AuthenticatesAndRegistersUsers
{
    ...
    public function postRegister(Request $request)
    {
        ...
        if ($user->save()) {
            $data = array('email' => $user->email, 'code' => $activation_code, 'link' => URL::to('/') . '/activate/' . $activation_code);
...
class Carbon extends DateTime
{
    ...
    public static function setLocale($locale)
    {
        ...
        static::translator()->addResource('array', require '/home/www/tmihalis/parkinglegend.com/www/lvroot/vendor/nesbot/carbon/src/Carbon' . '/Lang/' . $locale . '.php', $locale);
    }
