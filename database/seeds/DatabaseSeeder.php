...
class ParkingTableSeeder extends Seeder {
    ...
    public function run()
    {
        ...
        Parking::create(['parking_name' => 'Chelnik Parking',
                         ...
                         'non_work_hours'   => '{"business":{"from":"00:00", "to":"23:59"}, "saturday":{"from":"07:00", "to":"23:59"},"sunday":{"from":"08:00", "to":"23:00"}}']);
...
class AvailabilityTableSeeder extends Seeder {
    ...
    public function run()
    {
        ...
        //1
        Availability::create(['parking_id' => 1, 'date' => '2015-8-1', 'time_start' => '03:00:00', 'time_end' => '06:00:00', 'slots' => 3, 'remaining_slots' => 1, 'status' => 'A']);
        Availability::create(['parking_id' => 1, 'date' => '2015-8-2', 'slots' => 3, 'remaining_slots' => 1, 'status' => 'A']);
        Availability::create(['parking_id' => 1, 'date' => '2015-8-3', 'slots' => 3, 'remaining_slots' => 3, 'status' => 'A']);

        //2
        Availability::create(['parking_id' => 2, 'date' => '2015-8-1', 'slots' => 10, 'remaining_slots' => 1,  'status' => 'A']);
        Availability::create(['parking_id' => 2, 'date' => '2015-8-2', 'slots' => 10, 'remaining_slots' => 5,  'status' => 'A']);
        Availability::create(['parking_id' => 2, 'date' => '2015-8-3', 'slots' => 10, 'remaining_slots' => 10, 'status' => 'A']);

        //3
        Availability::create(['parking_id' => 3, 'date' => '2015-8-1', 'slots' => 5, 'remaining_slots' => 5, 'status' => 'A']);
        Availability::create(['parking_id' => 3, 'date' => '2015-8-2', 'slots' => 5, 'remaining_slots' => 5, 'status' => 'I']);
        Availability::create(['parking_id' => 3, 'date' => '2015-8-3', 'slots' => 5, 'remaining_slots' => 0, 'status' => 'I']);

        //10
        Availability::create(['parking_id' => 10, 'date' => '2015-8-1', 'slots' => 3, 'remaining_slots' => 1, 'status' => 'A']);
    }
...
class UserTableSeeder extends Seeder {
    ...
    public function run()
    {
        ...
        User::create(['email'       => 't_mihalis@gmail.com', 
...
class TranslationTableSeeder extends Seeder {
    ...
    public function run()
    {
        ...
        Translation::create(['locale'      => 'el', 
                             'column_name' => 'description',
                             'value'       => 'Περιγραφή πάρκινγκ στα ελληνικά',  
                             'table_name'  => 'PARKING',
                             'identifier'  => '1']);

        Translation::create(['locale'      => 'el', 
                             'column_name' => 'reserve_notes',
                             'value'       => 'Κατά την άφιξή σας, δείξτε το κουπόνι της κράτησής σας στον υπάλληλο.',  
                             'table_name'  => 'PARKING',
                             'identifier'  => '1']);

        Translation::create(['locale'      => 'el', 
                             'column_name' => 'find_it',
                             'value'       => 'Βρείτε το πηγαίνωντας δεξιά και μετά αριστερά.',  
                             'table_name'  => 'PARKING',
                             'identifier'  => '1']);
        ...
        Translation::create(['locale' => 'el', 'column_name' => 'name', 'value' => 'Ελλάδα',      'table_name' => 'LOCATION', 'identifier' => '2']);
        Translation::create(['locale' => 'el', 'column_name' => 'name', 'value' => 'Θεσσαλονίκη', 'table_name' => 'LOCATION', 'identifier' => '12']);
        Translation::create(['locale' => 'el', 'column_name' => 'name', 'value' => 'Αθήνα',       'table_name' => 'LOCATION', 'identifier' => '11']);

        Translation::create(['locale' => 'el', 'column_name' => 'name', 'value' => 'Ηνωμένο Βασίλειο', 'table_name' => 'LOCATION', 'identifier' => '1']);
        Translation::create(['locale' => 'el', 'column_name' => 'name', 'value' => 'Λονδίνο',          'table_name' => 'LOCATION', 'identifier' => '3']);
        ...
        //Tags
        Translation::create(['locale' => 'el', 'column_name' => 'name', 'value' => 'Κάμερες Κλειστού Κυκλώματος', 'table_name' => 'TAG', 'identifier' => '14']);
    }
...
class ConfigurationTableSeeder extends Seeder {
    ...
    public function run()
    {
        ...
        Configuration::create(['parking_id' => 1, 'conf_name' => 'CURRENCY',    'value' => '€']);
        Configuration::create(['parking_id' => 1, 'conf_name' => 'CURRENCY_ORDER', 'value' => 'R']);

        Configuration::create(['parking_id' => 2, 'conf_name' => 'CURRENCY',    'value' => '€']);
        Configuration::create(['parking_id' => 2, 'conf_name' => 'CURRENCY_ORDER', 'value' => 'R']);
        Configuration::create(['parking_id' => 3, 'conf_name' => 'CURRENCY',    'value' => '€']);
        Configuration::create(['parking_id' => 3, 'conf_name' => 'CURRENCY_ORDER', 'value' => 'R']);
        Configuration::create(['parking_id' => 4, 'conf_name' => 'CURRENCY',    'value' => '€']);
        Configuration::create(['parking_id' => 4, 'conf_name' => 'CURRENCY_ORDER', 'value' => 'R']);
        Configuration::create(['parking_id' => 5, 'conf_name' => 'CURRENCY',    'value' => '€']);
        Configuration::create(['parking_id' => 5, 'conf_name' => 'CURRENCY_ORDER', 'value' => 'R']);
        Configuration::create(['parking_id' => 6, 'conf_name' => 'CURRENCY',    'value' => '€']);
        Configuration::create(['parking_id' => 6, 'conf_name' => 'CURRENCY_ORDER', 'value' => 'R']);
        Configuration::create(['parking_id' => 7, 'conf_name' => 'CURRENCY',    'value' => '€']);
        Configuration::create(['parking_id' => 7, 'conf_name' => 'CURRENCY_ORDER', 'value' => 'R']);
        Configuration::create(['parking_id' => 8, 'conf_name' => 'CURRENCY',    'value' => '€']);
        Configuration::create(['parking_id' => 8, 'conf_name' => 'CURRENCY_ORDER', 'value' => 'R']);
        Configuration::create(['parking_id' => 9, 'conf_name' => 'CURRENCY',    'value' => '€']);
        Configuration::create(['parking_id' => 9, 'conf_name' => 'CURRENCY_ORDER', 'value' => 'R']);
        Configuration::create(['parking_id' => 10, 'conf_name' => 'CURRENCY',    'value' => '€']);
        Configuration::create(['parking_id' => 10, 'conf_name' => 'CURRENCY_ORDER', 'value' => 'R']);
